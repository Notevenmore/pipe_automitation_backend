...
class DE_Rand_Best_1:
        ...
        for i in range(self.iter):
            ...
            for j in range(pop_size):
                ...
                while(True):
                    ...
                    c, d, a = pop_pipe[np.random.choice(candidates, 3, replace=False)]
                    # Perform mutation
                    mutated = self.mutation([a, b, c, d])
    ...
    def get_best_b1(self):
        ...
        demand1_index = 0
        for i in range(len(self.best_b1_b2[0])):
            if round(self.best_b1_b2[0][i][1]) == self.ps1:
                demand1_index = i
        best_b1 = []
        for p in self.best_b1_b2[0]:
        ...
        for i in range(self.iter):
            ...
            for j in range(pop_size):
                ...
                while(True):
                    ...
                    c, d, a = pop_pipe[np.random.choice(candidates, 3, replace=False)]
                    # Perform mutation
                    mutated = self.mutation([a, b, a, c, d])
                    # Check bound mutated vector
